...
out center;`
  ...
  // Filter restaurants based on selected cuisine and visit status
  const filterRestaurants = (cuisine = selectedCuisine, visitStatus = visitFilter) => {
  ...
  useEffect(() => {
    ...
    filterRestaurants(selectedCuisine, visitFilter)
  }, [allRestaurants, selectedCuisine, visitFilter, visitedRestaurants])
      ...
      <div className="restaurant-list">
        ...
        <div className="restaurant-grid">
          {restaurants.slice(0, 12).map((restaurant) => (
            <div
              key={restaurant.id}
              className={`restaurant-card ${isRestaurantVisited(restaurant.id) ? 'visited-card' : ''}`}
            >
